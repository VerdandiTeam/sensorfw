...
#ifndef HybrisBackendBinderAidl_H
#define HybrisBackendBinderAidl_H
...
class HybrisBackendBinderAidl : public HybrisBackendBinder
{
    Q_OBJECT
public:
    HybrisBackendBinderAidl(HybrisManager *manager, QObject *parent = 0);
    ~HybrisBackendBinderAidl();
    void initialize();
...
#endif // HybrisBackendBinderAidl_H
