 ...
 * for opening camera as that was the function on stock android. Reported value is
 * ignored if it arrives means it has been triggered. Available on motorola phones
 * only.
 */
